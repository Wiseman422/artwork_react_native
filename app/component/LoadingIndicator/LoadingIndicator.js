...
import {StyleSheet, View, Text, DeviceEventEmitter, ActivityIndicator} from 'react-native';
...
const LoadingIndicator = React.createClass({
    ...
    getInitialState() {
        return {isVisible: this.props.startVisible};
    },
    componentDidMount() {
            ...
            return (
                <View style={[styles.container]}>
                    <View style={customStyles.overlay}>
                        <ActivityIndicator color={this.props.color} size="small" style={styles.progressBar}/>
